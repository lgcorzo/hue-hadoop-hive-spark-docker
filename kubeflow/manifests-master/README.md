...
- [Kubeflow components versions](#kubeflow-components-versions)
  - [Kubeflow Version: latest](#kubeflow-version-latest)
- [Installation](#installation)
  ...
  - [Install individual components](#install-individual-components)
    ...
    - [Notebooks](#notebooks)
    - [PVC Viewer Controller](#pvc-viewer-controller)
...
The default way of accessing Kubeflow is via port-forward. This enables you to get started quickly without imposing any requirements on your environment. Run the following to port-forward Istio's Ingress-Gateway to local port `8082`:

```sh
kubectl port-forward svc/istio-ingressgateway -n istio-system 8082:80
```

http://127.0.0.1:8082/?ns=kubeflow-user-example-com

After running the command, you can access the Kubeflow Central Dashboard by doing the following:

1. Open your browser and visit `http://localhost:8082`. You should get the Dex login screen.
